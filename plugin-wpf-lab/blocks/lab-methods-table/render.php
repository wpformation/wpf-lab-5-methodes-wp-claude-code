...
$methods = array(
    ...
    array( 'n' => '07', 'name' => 'blocs php custom',                     'tag' => '★ LA NOUVELLE',       'blurb' => 'Plugin custom + blocs PHP WP 7.0 autoGenerateControl. Design figé, édition lockée.', 'verdict' => '« Design verrouillé, édition non-destructive. »',      'scores' => array( 5.0, 5.0, 5.0, 5.0 ), 'total' => 5.0,  'url' => '/methode-blocs-php-custom/' ),
);
